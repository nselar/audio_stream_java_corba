...
{
  private static String  _id = "IDL:sop_corba/Buffer:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (sop_corba.BufferHelper.id (), "Buffer", __typeCode);
    }
    return __typeCode;
  }
